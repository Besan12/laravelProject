            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="<?php echo e(URL::to('/createCourse')); ?>" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\Laravel\assignment\resources\views/dashboard/createCourse.blade.php ENDPATH**/ ?>